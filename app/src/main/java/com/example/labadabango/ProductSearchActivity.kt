...
import com.example.labadabango.databinding.ActivityScanBinding
...
class ProductSearchActivity : AppCompatActivity(), ZXingScannerView.ResultHandler {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scannerView?.setBorderColor(Color.parseColor("#1ba1dd"))
        scannerView?.setLaserColor(Color.parseColor("#1ba1dd"))
    ...
    override fun handleResult(p0: Result?) {
        ...
        val intent = Intent(this, LaundryListFragment::class.java).apply {
