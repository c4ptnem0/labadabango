...
import com.example.labadabango.EmailVerification
import com.example.labadabango.Login
import com.example.labadabango.R
import com.example.labadabango.databinding.ActivityRegisterBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.signUpBtn.setOnClickListener {
            ...
            if(userName.isNotEmpty() && firstName.isNotEmpty() && lastName.isNotEmpty() &&
                email.isNotEmpty() && password.isNotEmpty() && conPassword.isNotEmpty())
            {
